          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
            {components.length === 0 ? (
              <div className="p-16 text-center">
                <p className="text-slate-500 dark:text-slate-400">No components added yet</p>
              </div>
            ) : (
                      ...
                      <tr key={comp.partCode} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <span className={`px-2.5 py-1 rounded text-xs font-medium ${
                            comp.partType === 'RAW_MATERIAL' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300' :
                            comp.partType === 'COMPONENT' ? 'bg-purple-100 text-purple-800 dark:bg-purple-900/50 dark:text-purple-300' :
                            comp.partType === 'PACKAGING' ? 'bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300' :
